    ...
    <SafeView>
      ...
      >
        <ScrollView className="flex-1 bg-gray-50" keyboardShouldPersistTaps="handled">
          ...
          {/* In-Home Service */}
          <View className="bg-white mx-4 mt-4 rounded-xl p-4 border border-gray-100">
            <Text className="text-base font-semibold text-gray-900 mb-4">In-Home Service</Text>
          ...
          <View className="mx-4 mt-4 mb-8 bg-indigo-50 rounded-xl p-4 flex-row">
            ...
            <Text className="text-sm text-indigo-700 ml-2 flex-1">
              Keep your business info up to date to attract more clients. A detailed profile with
              specialties helps you appear in the right searches.
            </Text>
          </View>
        </ScrollView>
