    ...
    <SafeView>
      ...
      >
        <ScrollView className="flex-1 bg-gray-50" keyboardShouldPersistTaps="handled">
          ...
          {/* Address form */}
          <View className="bg-white mx-4 mt-4 rounded-xl p-4 border border-gray-100">
            <Text className="text-base font-semibold text-gray-900 mb-4">Business Address</Text>
          ...
          <View className="mx-4 mt-4 mb-8 bg-amber-50 rounded-xl p-4 flex-row">
            ...
            <Text className="text-sm text-amber-700 ml-2 flex-1">
              Your location is used to display your shop on the map for nearby clients. Make sure
              the address is accurate to ensure correct placement.
            </Text>
          </View>
        </ScrollView>
        ...
        <View className="bg-white px-4 py-4 border-t border-gray-100">
          <Button onPress={handleSave} disabled={isSaving || !hasChanges} loading={isSaving}>
            Save Location
          </Button>
          {!hasChanges && (
